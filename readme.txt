...
Donate link: https://www.paypal.me/csehasib/10
...
Please show your support for this plugin by giving it [a rating](https://wordpress.org/support/view/plugin-reviews/news-headline-ticker?rate=5#postform) :)

Now hosted at [GitHub](https://github.com/hasibuli/news-headline-ticker). 
...
* Compatibility with wp latest version and add donate link.

= 2.3.6 =

* Compatibility with wp version 4.9.5 and fix some another issue.

= 2.3.5 =

* Compatibility with wp version 4.8.1

= 2.3.3 =

* Compatibility with wp version 4.6
